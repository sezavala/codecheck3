...
public class FilesController {
    ...
    public Response filesHTML2(@PathParam("repo") String repo, @PathParam("problem") String problemName) throws IOException {
        try {
    ...
    @Produces(MediaType.TEXT_HTML)
    public Response filesHTML2(@PathParam("problem") String problemName) throws IOException {
    ...
    @Produces(MediaType.TEXT_HTML)
    public Response filesHTML2queryParams(@QueryParam("repo") String repo, @QueryParam("problem") String problemName) throws IOException {
    ...
    @Produces(MediaType.TEXT_HTML)
    public Response tracer(@PathParam("repo") String repo, @PathParam("problem") String problemName) throws IOException {
        try {
            if (ccid == null) ccid = Util.createPronouncableUID();
    ...
    public Response fileData(@PathParam("repo") String repo, @PathParam("problem") String problemName) throws IOException {
        try {
            if (ccid == null) ccid = Util.createPronouncableUID();
